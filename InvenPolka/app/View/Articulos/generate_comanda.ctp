...
foreach ($articulos as $art){
	...
	//Deposito baires
	if ($art["articulos_vista"]["DepositoBaires"] == 'T'){
		$lefthtml.=
		'<td width="100" align="center"><img style="width:80px; height:80px;border-style:solid;border-width:0px;" src="/InvenPolka/app/webroot/files/articulo/idFoto/'.$art["articulos_vista"]["id"].'/small_'.$art["articulos_vista"]["idFoto"].'"><br>'.$art["articulos_vista"]['CodigoArticulo'].'<br><font style="text-align: center;font-size: 10px;color: #568E68;"><b> (BAIRES) </b></font>'.'</td>';		
