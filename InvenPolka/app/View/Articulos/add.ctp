...
//            echo $this->Form->input('Inventario.IdDeposito',array('type'=>'select','options'=>$depositos,'empty'=>false,'class'=>'uniformselect items-select','div'=>false,'label'=>false,'before'=>'<p><label class="field categorias items-title"> Deposito : </label><span class="field float">','after'=>'</span></p>'));
            ...
            echo $this->Form->input('Articulo.DepositoBaires',array('type'=>'select','options'=>array('F' => 'Baires'),'empty'=>false,'class'=>'uniformselect items-select','div'=>false,'label'=>false,'before'=>'<p><label class="field categorias items-title"> Deposito : </label><span class="field float">','after'=>'</span></p>'));
