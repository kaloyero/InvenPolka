...
echo $this->Form->input('Articulo.DepositoBaires',array('type'=>'select','options'=>array('F' => 'Baires'),'empty'=>false,'class'=>'uniformselect','div'=>false,'label'=>false,'before'=>'<p><label> Deposito : </label><span class="field"> ','after'=>'</span></p>')); 
