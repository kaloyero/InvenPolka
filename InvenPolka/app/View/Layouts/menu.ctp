...
<label for="ArticuloSearchIdCategoria">Categoria</label>
                    ...
                    <?php if (! empty($privis['menuLeyendaInvitado'])) { ?>
						<div style="margin-left: 10px;margin-top: 15;" class="animate8 fadeInUp">	
                            <h1 style="COLOR: #A86643;">
							  Guía de uso
  							</h1>
                                <li style="color: #D5B46D;">1.	Utiliza el búscador para elegir artículos</li>
                                <li style="color: #D5B46D;">2.	Tilda los artículos que te interesen</li>
                                <li style="color: #D5B46D;">3.	Clic en Descargar Seleccionados</li>
                                <li style="color: #D5B46D;">4.	Para ALQUILER enviar Pdf a "parizaga@pol-ka.com.ar"</li>
							<br>
							<c style="color: antiquewhite; font-size: 10px;">
							    Los artículos pueden diferir de las fotografías.
						    </c>
                        </div>
					<?php } ?>

                    <?php if (! empty($privis['menuLeyendaArte'])) { ?>
						<div style="margin-left: 10px;margin-top: 15px;" class="animate8 fadeInUp">	
                            <h1 style="COLOR: #A86643;">
							  Guía de uso
  							</h1>
                                <c style="color: antiquewhite; font-size: 13px;">
                                    Crear Pedido
                                </c>
                                <li style="color: #D5B46D;">1.	Utiliza el búscador para elegir artículos</li>
                                <li style="color: #D5B46D;">2.	Tilda los artículos que te interesen</li>
                                <li style="color: #D5B46D;">3.	Clic en 'Crear Pedido'</li>
                                <li style="color: #D5B46D;">4.	completar campos requeridos y Aceptar</li>
                                <BR>
                                <c style="color: antiquewhite; font-size: 13px;">
                                    Inventario
                                </c>
                                <li style="color: #D5B46D;">Puede consultar el inventario disponible</li>
                                <li style="color: #D5B46D;">1.	Filtrar por deposito </li>
                                <li style="color: #D5B46D;">Muestra el inventario para el deposito</li>
                                <li style="color: #D5B46D;">2.	Filtrar por Proyecto </li>
                                <li style="color: #D5B46D;">Muestra el inventario del proyecto seleccionado</li>

                                <BR>
                                <c style="color: antiquewhite; font-size: 13px;">
                                    Pedidos realizados
                                </c>
                                <li style="color: #D5B46D;">Puede consultar el estado de sus Pedidos </li>
                                <li style="color: #D5B46D;">1.	Ver detalles de Pedido</li>
                                <li style="color: #D5B46D;">2.	Descargar comanda del Pedido</li>
							<br>
